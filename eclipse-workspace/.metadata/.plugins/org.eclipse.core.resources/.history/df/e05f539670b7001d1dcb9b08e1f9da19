...
int main(int argc, char** argv)
{
	...
	plus_button->on_click([&green_wire_image,&blinking_green_wire_timer,&battery_progress_bar, &percentage_charged_text, &remaining_time_value,&elapsed_time_text,&delivered_energy_text,&battery_fully_charged_text,&screen_saver_timer](egt::Event &)
	{
